...
I> Xamarin.Forms is unique by offering a single language(C#) and runtime that works across all the three mobile platforms of iOS, Android, UWP and macOS platform as well. So, the data grid for Xamarin.Forms works in all the three platforms.
