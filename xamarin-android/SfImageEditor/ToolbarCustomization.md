...
Bradley Hand, SignPainter, Opacity, Path, StrokeThickness, Colors, Opacity, Shape, Rectangle, StrokeThickness, Circle, Arrow, Transform, Crop, free, original, square, 3:1, 3:2, 4:3, 5:4, 16:9, Rotate, Flip, Reset, Undo, Redo, TextAlignment,Left, Right, Center, TextEffects, Bold, Italic,Underline and Save"
...
N> You can customize icon by specifying its [names](/xamarin-android/sfimageeditor/toolbarcustomization#name)
