...
For more information regarding calculating with `CalcQuickBase`, refer [here](https://help.syncfusion.com/xamarin-android/calculate/working-with-calcquick)
...
For more information regarding calculating with `ICalcData`, refer [here](https://help.syncfusion.com/xamarin-android/calculate/working-with-icalcdata)
