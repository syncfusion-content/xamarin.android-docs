...
description: Describes the filling and signing forms in the PDF document using Syncfusion PDF Viewer Xamarin.Android.
...
The value of the [IsXFAForm](https://help.syncfusion.com/cr/cref_files/xamarin-android/Syncfusion.SfPdfViewer.Android~Syncfusion.SfPdfViewer.Android.SfPdfViewer~IsXFAForm.html) property indicates whether the PDF loaded contains XFA form. 
