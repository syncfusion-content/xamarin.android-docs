...
You can download the complete [`Xamarin.Android'](https://www.syncfusion.com/products/release-history/estudio/xamarin-android) component from [here](https://www.syncfusion.com/downloads/latest-version). You may be asked to choose the windows installer or zip file to download.
