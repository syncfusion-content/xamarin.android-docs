...
You can differentiate the timeslot panel using `VerticalLineColor` and `VerticalLineStrokeWidth` properties of `DayViewSettings`.To know more about customization of time slot panel refer [Panel Customization](/xamarin-android/sfschedule/Appearance-and-Styling "Panel Customization")
...
Also you can differentiate the timeslot panel using `VerticalLineColor` and `VerticalLineStrokeWidth` properties of `WeekViewSettings`.To know more about customization of time slot panel refer [Panel Customization](/xamarin-android/sfschedule/Appearance-and-Styling "Panel Customization")
...
You can also differentiate working hours with non-working hour timeslots by its color using `NonWorkingHoursTimeSlotBorderColor`, `NonWorkingHoursTimeSlotColor`, `TimeSlotColor`,`TimeSlotBorderColor` and `TimeSlotBorderStrokeWidth` properties of `WeekViewSettings`.To know more about customization of working hours refer [Panel Customization](/xamarin-android/sfschedule/Appearance-and-Styling "Panel Customization")
...
You can customize the month cells of MonthView using vaious properties of `MonthCellStyle`. To know more about customization of MonthView refer [MonthCell Customization](/xamarin-android/sfschedule/Appearance-and-Styling "MonthCell Customization")

### InlineAppointmentTapped Event

By enabling the Inline view feature, while tap on the schedule month view cell it will open a inline view which contains list of appointments on a particular day. To know more about Inline view of Month cell refer [Inline Customization](/xamarin-android/sfschedule/Appearance-and-Styling "Inline Customization").
