...
* If schedule Time zone was set ant Appointment's start time zone and end time zone are not set then appointment's start time and end time value to be converted into schedule time zone for specified time zone
