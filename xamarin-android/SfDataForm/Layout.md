...
N> Setting `ColumnCount` to SfDataForm does not arrange the elements in a group according to the column count.To set ColumnCount for DataFormGroupItem refer [here](https://help.syncfusion.com/xamarin-android/sfdataform/layout?cs-save-lang=1&cs-lang=csharp#loading-different-layout-for-group)
