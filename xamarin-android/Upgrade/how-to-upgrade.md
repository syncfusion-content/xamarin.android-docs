...
description: Learn here about the how upgrade Syncfusion<sup>®</sup> Xamarin.Android installer to a latest version from website and control panel.
platform: xamarin.android
control: Essential Studio<sup>®</sup>
documentation: ug
---

# Upgrading Syncfusion<sup>®</sup> Xamarin.Android installer to a latest version
