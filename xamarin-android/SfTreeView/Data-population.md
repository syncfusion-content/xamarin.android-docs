...
To update the collection changes in UI, it is necessary to define the[NotificationSubscriptionMode](https://help.syncfusion.com/cr/cref_files/xamarin-android/Syncfusion.SfTreeView.Android~Syncfusion.Android.TreeView.SfTreeView~NotificationSubscriptionMode.html) to treeview as the CollectionChanged /PropertyChanged.
